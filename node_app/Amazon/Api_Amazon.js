module.exports = function (_, mysql, apiKey, apiUser) {
    ...
    return {
        getDb: function (req, res, _cb) {
            ...
            mysql.query('SELECT * FROM books WHERE length(_loc)>0 and _sale is null and price_quantity>0 and length(universalIdentifier_number)>2 order by vendorlistingid;', function (err, records) {
